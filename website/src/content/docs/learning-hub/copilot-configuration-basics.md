...
| `defaultMode` | Default startup mode for new interactive sessions: `interactive`, `plan`, or `autopilot` (v1.0.81+) |
| `defaultPermissionMode` | Default approval behavior for new interactive sessions: `default`, `allow-all`, or `auto` (v1.0.81+) |
